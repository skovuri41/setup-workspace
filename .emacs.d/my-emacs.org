...
***** Copy the word,line,paragraph,string and parenthesis.
...
***** emacs swtich next prev user buffer - xah
#+begin_src emacs-lisp :tangle yes
...
(global-set-key (kbd "C-c h")  (quote copy-paragraph))
...
*** IN-PROGRESS cider newer version not working, missing package queue
